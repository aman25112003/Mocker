...
const RecordAnswerSection = ({
  ...
  const UpdateUserAnswer = async () => {
    ...
    const resp = await db.insert(UserAnswer).values({
      ...
      correctAns:
        mockInterviewQuestion[0].questions[activeQuestionIndex]?.answer,
      userAns: userAnswer,
    ...
    if (resp) {
      ...
      toast("Something went wrong please record again");
    }
    setResults([]);
    setLoading(false);
  };
  ...
  return (
    <div className="flex justify-cente items-center flex-col">
      <div className="flex flex-col my-20 w-full h-full justify-center items-center bg-black rounded-lg p-5">
        <Image
          src={"/webcam.png"}
          width={200}
          height={200}
